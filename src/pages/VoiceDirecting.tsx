...
export default function VoiceDirecting() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 uppercase tracking-wide border-b-4 border-[#00FFFF] pb-2 inline-block">
          Featured Scenework
        </h2>
        ...
        {projects.map((project, i) => (
          ...
          >
            <a href={project.link} target="_blank" rel="noopener noreferrer" className="block text-center">
              <div className="w-full aspect-[16/9] relative overflow-hidden mb-6 bg-transparent rounded-[16px] transition-all duration-300 ease-out group-hover:scale-105 group-hover:shadow-2xl group-hover:shadow-black/50">
                <img 
                  src={project.image || `https://picsum.photos/seed/${project.imageSeed}/800/450`}
                  alt={project.title}
